...
<ol class="toolbar">
    <li class="btn-item"><a title="Nuevo" href="/admin/sucursales/nuevo" class="fa fa-plus-circle" aria-hidden="true"><span>Nuevo</span></a></li>
        ...
        <form id="form1" method="POST">
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="{{$sucursal->descripcion}}" required>
                </div>
                <div class="form-group col-lg-6">
                    <label>Linkmap: *</label>
                    <input type="text" id="txtLinkmap" name="txtLinkmap" class="form-control" value="{{$sucursal->linkmap}}" required>
                </div>
        </form>
</div>
