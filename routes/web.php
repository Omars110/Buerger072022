...
Route::group(array('domain' => '127.0.0.1'), function () {
    ...
    Route::get('/cerrar-sesion', 'ControladorWebIniciarSeccion@cerrarSesion');
    Route::get('/iniciar-sesion', 'ControladorWebIniciarSeccion@index');
    Route::post('/iniciar-sesion', 'ControladorWebIniciarSeccion@ingresar');
